...
result1=goldMedal("marks.txt")
print(result1[0],"are the toppers in",result1[6][0],"with marks",result1[7])
result2=goldMedal("marks2.txt")
print(result2[0],"are the toppers in",result2[6][0],"with marks",result2[7])
